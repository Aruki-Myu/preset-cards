...
|---|---|---|---|---|---|
| 预设甲 | 208,879 B | 1,387 B | 41,612 B | 4,589 B | 47,588 B (23%) |
| 预设乙 | 561,618 B | 1,386 B | 74,654 B | 5,862 B | 81,902 B (15%) |
| 预设丙 | 1,098,470 B | 1,030 B | 436,191 B | 11,703 B | 448,924 B (41%) |

结论：
- A 标量 + C order 几乎免费（合计 3~13KB）。
- **prompts 是成本决定项**：预设甲 42KB / 预设乙 75KB 尚可，但 **预设丙 达 436KB**（单条 content 有 144KB）。对这类预设，全量 profile ≈ preset 文件翻倍。
